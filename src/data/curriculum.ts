...
export const curriculum: StageData[] = [
  {
    ...
    specializations: [
      ...
      },
      {
        ...
        name: 'الزراعة',
        subjects: [
          { name: 'علوم النبات والتربة', hours: 60 },
          { name: 'إنتاج وإدارة النباتات', hours: 60 },
          { name: 'نظم الزراعة البيئية', hours: 60 },
          { name: 'تحسين محركات الأراضي', hours: 60 },
          { name: 'تشغيل تقنيات عمليات العمل في الأراضي', hours: 60 },
          { name: 'تربية حيوانات المزرعة', hours: 60 },
        ],
      },
    ],
  },
  {
    ...
    specializations: [
      ...
      {
        id: 'tawjihi-agriculture',
        name: 'الزراعة',
        subjects: [
          { name: 'تصوير مؤسسات الأراضي', hours: 60 },
          { name: 'الأنشطة التشغيلية والإنشائية في مؤسسات الأراضي', hours: 60 },
          { name: 'أنظمة الإنتاج الحيواني', hours: 60 },
          { name: 'الأنشطة البستنية لتنسيق النباتات وإكثارها', hours: 60 },
          { name: 'إنتاج المحاصيل البستانية', hours: 60 },
          { name: 'إدارة الموارد المائية', hours: 60 },
        ],
      },
    ],
  },
